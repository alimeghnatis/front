/**
 * @generated SignedSource<<0dbded56be7e3570b3cfbc5cfdcece51>>
...
export type ApplicationQuery$data = {
  ...
  readonly " $fragmentSpreads": FragmentRefs<"HomePageLoginButtonFragment" | "LoginPageButtonFragment" | "ProviderBoardFragment">;
};
