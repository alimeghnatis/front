/**
 * @generated SignedSource<<3648e8a02d2be8fdf36c5ec98297853d>>
...
export type WordAnalysisFragment$data = {
  ...
  readonly " $fragmentType": "WordAnalysisFragment";
};
export type WordAnalysisFragment$key = {
  readonly " $data"?: WordAnalysisFragment$data;
...
(node as any).hash = "4ab73ee2cbeb06526008f3ef8184c7ba";
