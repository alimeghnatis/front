/**
 * @generated SignedSource<<feb1de1cc94586daeb11eb66abfb39fb>>
...
export type WordFragment$data = {
  ...
  readonly " $fragmentType": "WordFragment";
};
export type WordFragment$key = {
  readonly " $data"?: WordFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"WordFragment">;
};
...
(node as any).hash = "c6f5545c98972d0f39fadc4addb606da";
