/**
 * @generated SignedSource<<0a5d6687d9643629b0e934403bb81eec>>
...
export type DefaultGroupStoriesQuery$variables = Record<PropertyKey, never>;
export type DefaultGroupStoriesQuery$data = {
  readonly group: {
    readonly " $fragmentSpreads": FragmentRefs<"DefaultGroupFragment">;
  } | null | undefined;
};
export type DefaultGroupStoriesQuery = {
  response: DefaultGroupStoriesQuery$data;
  variables: DefaultGroupStoriesQuery$variables;
};
