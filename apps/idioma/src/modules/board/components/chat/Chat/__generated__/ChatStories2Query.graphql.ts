/**
 * @generated SignedSource<<52144de8d3c52325dc9fda87ef329959>>
...
export type ChatStories2Query$variables = Record<PropertyKey, never>;
export type ChatStories2Query$data = {
  readonly board: {
    readonly " $fragmentSpreads": FragmentRefs<"ChatFragment">;
  } | null | undefined;
};
export type ChatStories2Query = {
  response: ChatStories2Query$data;
  variables: ChatStories2Query$variables;
};
