/**
 * @generated SignedSource<<3c1a32502112937a429a2d8e243dcf6b>>
...
export type BoardPageSingleQuery$variables = {
  board: string;
};
export type BoardPageSingleQuery$data = {
  readonly board: {
...
export type BoardPageSingleQuery = {
  response: BoardPageSingleQuery$data;
  variables: BoardPageSingleQuery$variables;
};
