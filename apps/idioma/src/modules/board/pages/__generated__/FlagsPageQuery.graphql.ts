/**
 * @generated SignedSource<<96837fa67ae78ee9c4ec3960175b4a71>>
...
export type FlagsPageQuery$variables = Record<PropertyKey, never>;
export type FlagsPageQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"DebugGroupFragment">;
};
export type FlagsPageQuery = {
  response: FlagsPageQuery$data;
  variables: FlagsPageQuery$variables;
};
    ...
    "selections": [
      {
        ...
        "storageKey": "expressions(first:100,rating_Lte:4)"
      },
      {
        "alias": null,
        "args": (v0/*: any*/),
        ...
        "handle": "connection",
        "key": "DebugGroupFragment_expressions",
        "kind": "LinkedHandle",
        "name": "expressions"
      }
    ]
