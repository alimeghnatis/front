/**
 * @generated SignedSource<<758dad8886c64cd08531c6eea48748bf>>
...
export type SelectMenuBoardStoriesQuery$variables = Record<PropertyKey, never>;
export type SelectMenuBoardStoriesQuery$data = {
  readonly viewer: {
...
export type SelectMenuBoardStoriesQuery = {
  response: SelectMenuBoardStoriesQuery$data;
  variables: SelectMenuBoardStoriesQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "SelectMenuBoardStoriesQuery",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    "cacheID": "94cc9b7ca6f14c3107c37a504e149fee",
    "id": null,
    "metadata": {
      "connection": [
        {
    ...
    "name": "SelectMenuBoardStoriesQuery",
    "operationKind": "query",
    "text": "query SelectMenuBoardStoriesQuery {\n  viewer {\n    boardMemberships(first: 50) {\n      edges {\n        node {\n          id\n          role\n          board {\n            id\n            name\n            isDefault\n          }\n          __typename\n        }\n        cursor\n      }\n      pageInfo {\n        endCursor\n        hasNextPage\n      }\n    }\n    id\n  }\n}\n"
  }
};
})();

(node as any).hash = "7fc0c74697e1c5860b2ec99034a427ce";
