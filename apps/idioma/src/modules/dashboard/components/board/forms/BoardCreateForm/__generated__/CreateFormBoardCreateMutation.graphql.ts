/**
 * @generated SignedSource<<515bf930c10fd768f702e7431d8ff1d3>>
...
export type CreateFormBoardCreateMutation$variables = {
  connections: ReadonlyArray<string>;
  input: CreateBoardMutationInput;
};
export type CreateFormBoardCreateMutation$data = {
  readonly createBoard: {
    ...
    readonly instance: {
      ...
      readonly name: string;
      readonly " $fragmentSpreads": FragmentRefs<"BoardFragment" | "UpdateFormBoardFragment" | "VariantBoardFragment">;
    } | null | undefined;
  } | null | undefined;
};
export type CreateFormBoardCreateMutation = {
  response: CreateFormBoardCreateMutation$data;
  variables: CreateFormBoardCreateMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "CreateFormBoardCreateMutation",
    "selections": [
      {
        "alias": null,
        "args": (v2/*: any*/),
