...
export const Base: StoryObj<typeof Component> = { args: { children: 'Sample CreateForm' } }

/*
export const Base: StoryFn<typeof Component> = () => (
  <Component>Sample CreateForm</Component>
)
*/

/*
const Template: StoryFn<typeof Component> = (args) => <CreateForm {...args} />
